...
app.get("/api/robustness/full", async (req, res) => {
  try {
    ...
    const result = await fullRobustnessReport(processedTrades, engineOpts, {
      ...
      mcMethod:      req.query.mcMethod                || 'bootstrap',
      seed:          parseInt(req.query.seed)          || 12345,
      numThreads:    parseInt(req.query.numThreads)    || 4,
      blockSize:     parseInt(req.query.blockSize)     || 0,
      dropoutRate:   parseFloat(req.query.dropoutRate) || 0,
      noiseLevel:    parseFloat(req.query.noiseLevel)  || 0,
